...
function personBlock(person, credits) {
  // Memakai helper img() agar URL poster TMDB terisi domain lengkap (https://image.tmdb.org/t/p/w500...)
  const profileImage = img(person.profile_path, 'w500') || 'https://placehold.co/300x450/17171b/ffffff?text=Kein+Foto';
